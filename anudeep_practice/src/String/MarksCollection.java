...
public class MarksCollection {
	...
	public static void main(String[] args) {
        ...
        int[][][] marks = new int[NoSchools][NoClasses][StudentsMarks];
        
        Scanner sc = new Scanner(System.in);
        
     // Collect marks of students for each school, class, and student
        for (int school = 0; school < NoSchools; school++) {
            ...
            for (int classNo = 0; classNo < NoClasses; classNo++) {
                ...
                for (int student = 0; student < StudentsMarks; student++) {
